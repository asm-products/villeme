...
ActiveRecord::Schema.define(version: 20141020201747) do
  ...
  create_table "events_prices", id: false, force: true do |t|
    t.integer  "event_id"
    t.integer  "price_id"
    t.datetime "created_at"
    t.datetime "updated_at"
  ...
  add_index "events_prices", ["event_id"], name: "index_events_prices_on_event_id"
  add_index "events_prices", ["price_id"], name: "index_events_prices_on_price_id"
