    ...
    BootstrapJS = {
      ...
      Popover: function() {
        ...
        $(document).click(function(e) {
          if (!$(e.target).is(".has-popover-click, .popover-title, .popover-content, .popover")) {
  ...
  (function($) {
    ...
    Ux = {
      ...
      AjaxTransition: function() {
        ...
        $(document).on('ready page:done', function() {
          $("#main").fadeIn(600);
          NProgress.done();
        });
      },
      ...
      SidebaLeft: function() {
        $(".sub-nav-anchor").click(function() {
          return $(this).next(".sub-nav").toggleClass("hide");
        });
      },
      ModalFeedback: function() {
        $('#modal-feedback').on('ajax:success', function(event, data, status, xhr) {
          $(this).modal("hide");
      ...
      HoverActions: function() {
        ...
        $(document).on('mouseleave', '.has-hover-action', function() {
...
(function() {
  (function($) {
    ...
    App = {
       ...
       */
      NewsfeedNotification: function() {
        $(document).on('click', '#newsfeed-link', function() {
          $.ajax({
            url: "/notify/newsfeed"
          }).done(function(data) {
            if (data.success) {
       ...
       */
      AgendaButton: function() {
        $(document).on('click', '.agenda-btn', function() {
          $.ajax({
            url: $(this).attr("data-schedule-url")
          }).done(function(data) {
            var agenda_new_count, agended, agended_by_new_count, event, new_title;
            event = $("#" + data.event);
      ...
      FriendActions: function() {
        ...
        $(document).on('click', '.friend-destroy', function() {
          $.ajax({
