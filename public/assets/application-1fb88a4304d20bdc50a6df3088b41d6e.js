...
(function() {
  $(document).ready(function() {
    var sidebarSize, size;
    $(".col-fixed").affix();
    size = $(".col-md-3").width();
    $(".col-fixed").css("width", size);
    sidebarSize = $(".sidebar").width();
    $("#user-map").css("width", sidebarSize + 30);
    $(".excluir").click(function() {
      var anchor;
      anchor = $(this).attr("data-anchor");
      return $(this).parents(anchor).fadeOut("slow");
    });
    $(window).resize(function() {
      var sizeOnResize;
      sizeOnResize = $(".col-md-9").width();
      $(".col-fixed").css("width", sizeOnResize / 4 + 50);
      sidebarSize = $(".sidebar").width();
      $("#user-map").css("width", sidebarSize + 30);
    });
  ...
  $(document).ready(function() {
    var position, width;
    $(".panel select").addClass("mySelectBoxClass");
    $('.mySelectBoxClass').customSelect();
    $('.panel .customSelectInner').each(function() {
      var size;
      size = $(this).width();
      return $(this).css('width', size + 20);
    });
    ...
    $('.layout-centralize').find('.mySelectBoxClass').css('width', '100%');
    $('.layout-centralize').find('.customSelectInner').css('width', '100%');
    width = $('.layout-centralize').find('.customSelectInner').width();
    $('.layout-centralize').find('.hasCustomSelect').css('width', width);
