...
(function() {
  $(function() {
    var buscaLatlong, map;
    $(".event_date select").wrapAll("<div class='col-xs-9'></div>");
    ...
    buscaLatlong = function(endereco) {
      $("#map").gmap3({
        clear: {
          name: "marker"
        },
        getlatlng: {
          ...
          callback: function(results) {
            var latLng, latitude, longitude, map;
            if (!results) {
                    ...
                    dragend: function(marker) {
                      $(this).gmap3({
                        getaddress: {
                          ...
                          callback: function(results) {
                            var content, infowindow, latLng, latitude, longitude, map;
                            map = $(this).gmap3("get");
    ...
    $("#map").gmap3({
      ...
      marker: {
        latLng: [gon.latitude, gon.longitude],
        options: {
          draggable: true
        },
        events: {
